...
public class LineTest {
	...
	@Test
	public void getLineOffset() {
		assertEquals(0, new Line(1, 0, "abc").getLineOffset());
		assertEquals(1, new Line(1, 1, "abc").getLineOffset());
	}

	@Test
	public void toStringTest() {
		assertEquals("Line{lineNumber=1, lineOffset=15, text=1}", new Line(1, 15, "1").toString());
		assertEquals("Line{lineNumber=2, lineOffset=0, text=\\t\\r\\nabc}", new Line(2, 0, "\t\r\nabc").toString());
		assertEquals("Line{lineNumber=0, lineOffset=0, text=aaaaaaaaaaaaaaaaaaaa...}",
	...
	public void segment() {
		...
		assertEquals(15 + 3, segment.getLineOffset());
