...
public class SetextHeaderBlockTest {
	...
	public void canStart() {
		assertTrue(block.canStart(new LineSequence("Heading\n-")));
		assertTrue(block.canStart(new LineSequence("Heading\n=")));
		assertTrue(block.canStart(new LineSequence("Heading\n  =")));
		assertTrue(block.canStart(new LineSequence("Heading\n   =")));
		assertFalse(block.canStart(new LineSequence("Heading\n    =")));
		assertTrue(block.canStart(new LineSequence("Heading\n=====")));
		assertTrue(block.canStart(new LineSequence("Heading Text\n-----")));
		assertFalse(block.canStart(new LineSequence("Heading\n\n=====")));
		assertTrue(block.canStart(new LineSequence("   Heading\n=====")));
		assertFalse(block.canStart(new LineSequence("    Heading\n=====")));
	}
