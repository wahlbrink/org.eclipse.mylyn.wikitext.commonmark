...
public class AutoLinkSpan extends SourceSpan {
	...
	private static final Set<String> SCHEMES = ImmutableSet.of("coap", "doi", "javascript", "aaa", "aaas", "about",
			...
			"iris.lwz", "ldap", "mailto", "mid", "msrp", "msrps", "mtqp", "mupdate", "news", "nfs", "ni", "nih",
			"nntp", "opaquelocktoken", "pop", "pres", "rtsp", "service", "session", "shttp", "sieve", "sip", "sips",
			"sms", "snmp,soap.beep", "soap.beeps", "tag", "tel", "telnet", "tftp", "thismessage", "tn3270", "tip",
			"tv", "urn", "vemmi", "ws", "wss", "xcon", "xcon-userid", "xmlrpc.beep", "xmlrpc.beeps", "xmpp", "z39.50r",
			...
			"oid", "palm", "paparazzi", "platform", "proxy", "psyc", "query", "res", "resource", "rmi", "rsync",
			"rtmp", "secondlife", "sftp", "sgn", "skype", "smb", "soldat", "spotify", "ssh", "steam", "svn",
	...
	public Optional<? extends Inline> createInline(Cursor cursor) {
		...
		if (c == '<') {
			...
			if (matcher.matches()) {
				...
				return Optional.of(new Link(cursor.getLineAtOffset(), cursor.getOffset(), href.length() + 2,
						escapeUri(link), null, ImmutableList.<Inline> of(new Characters(cursor.getLineAtOffset(),
								cursor.getOffset() + 1, href))));
			}
		}
