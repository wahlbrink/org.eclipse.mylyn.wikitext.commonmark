...
public class CommonMarkLanguage extends MarkupLanguage {
	...
	public void processContent(MarkupParser parser, String markupContent, boolean asDocument) {
		...
		ProcessingContext context = sourceBlocks.createContext(new LineSequence(markupContent));
		sourceBlocks.process(context, builder, new LineSequence(markupContent));
